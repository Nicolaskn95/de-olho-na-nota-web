      ...
      {!conteudoLido && modo === "selecao" && !erro && (
        <div className="flex flex-col items-center gap-4">
          <div className="grid grid-cols-2 gap-3 w-full">
            ...
            {/* Upload imagem */}
            <label className="flex flex-col items-center gap-2 p-5 rounded-xl border-2 border-green-200 bg-green-50 hover:border-green-500 hover:bg-green-100 transition-all cursor-pointer group">
